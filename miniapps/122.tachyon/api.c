 ...
 * 
 *  $Id: api.c 499 2006-10-06 19:58:28Z keeper $
 */
...
// XXX RN: changed flt types to apiflt
void rt_extvol(SceneHandle scene, void * tex, apivector min, apivector max, int samples, apiflt (* evaluator)(apiflt, apiflt, apiflt)) {
